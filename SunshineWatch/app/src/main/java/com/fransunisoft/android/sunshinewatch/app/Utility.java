...
public class Utility {
    ...
    static public void updateWatchFace(Context c) {
        Intent intent = new Intent(c, com.fransunisoft.android.sunshinewatch.app.WatchService.class);
        intent.setAction(com.fransunisoft.android.sunshinewatch.app.WatchService.ACTION_UPDATE_WATCHFACE);
