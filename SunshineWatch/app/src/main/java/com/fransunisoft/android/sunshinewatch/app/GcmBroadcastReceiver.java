...
public class GcmBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_MESSAGE.equals(messageType)) {
                ...
                if (com.fransunisoft.android.sunshinewatch.app.MainActivity.PROJECT_NUMBER.equals(extras.getString(EXTRA_SENDER))) {
    ...
    private void sendNotification(Context context, String msg) {
        ...
        PendingIntent contentIntent =
                PendingIntent.getActivity(context, 0, new Intent(context, com.fransunisoft.android.sunshinewatch.app.MainActivity.class), 0);
