...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    final private com.fransunisoft.android.sunshinewatch.app.ItemChoiceManager mICM;
    ...
    public ForecastAdapter(Context context, ForecastAdapterOnClickHandler dh, View emptyView, int choiceMode) {
        ...
        mICM = new com.fransunisoft.android.sunshinewatch.app.ItemChoiceManager(this);
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherId = mCursor.getInt(com.fransunisoft.android.sunshinewatch.app.ForecastFragment.COL_WEATHER_CONDITION_ID);
        int defaultImage;
        boolean useLongToday;

        switch (getItemViewType(position)) {
            case VIEW_TYPE_TODAY:
                defaultImage = com.fransunisoft.android.sunshinewatch.app.Utility.getArtResourceForWeatherCondition(weatherId);
                useLongToday = true;
                break;
            default:
                defaultImage = com.fransunisoft.android.sunshinewatch.app.Utility.getIconResourceForWeatherCondition(weatherId);
                useLongToday = false;
        }

        if ( com.fransunisoft.android.sunshinewatch.app.Utility.usingLocalGraphics(mContext) ) {
            forecastAdapterViewHolder.mIconView.setImageResource(defaultImage);
        } else {
            Glide.with(mContext)
                    .load(com.fransunisoft.android.sunshinewatch.app.Utility.getArtUrlForWeatherCondition(mContext, weatherId))
                    .error(defaultImage)
                    .crossFade()
        ...
        long dateInMillis = mCursor.getLong(com.fransunisoft.android.sunshinewatch.app.ForecastFragment.COL_WEATHER_DATE);

        // Find TextView and set formatted date on it
        forecastAdapterViewHolder.mDateView.setText(com.fransunisoft.android.sunshinewatch.app.Utility.getFriendlyDayString(mContext, dateInMillis, useLongToday));

        // Read weather forecast from cursor
        String description = com.fransunisoft.android.sunshinewatch.app.Utility.getStringForWeatherCondition(mContext, weatherId);
        ...
        double high = mCursor.getDouble(com.fransunisoft.android.sunshinewatch.app.ForecastFragment.COL_WEATHER_MAX_TEMP);
        String highString = com.fransunisoft.android.sunshinewatch.app.Utility.formatTemperature(mContext, high);
        ...
        double low = mCursor.getDouble(com.fransunisoft.android.sunshinewatch.app.ForecastFragment.COL_WEATHER_MIN_TEMP);
        String lowString = com.fransunisoft.android.sunshinewatch.app.Utility.formatTemperature(mContext, low);
